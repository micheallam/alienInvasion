...
class Scoreboard:
    ...
    def prep_score(self):
        ...
        self.score_text_rect = self.score_text_image.get_rect() # new
        self.score_rect.right = self.screen_rect.right - 20
        self.score_text_rect.right = self.screen_rect.right - 20 # new
        self.score_rect.top = 40
        self.score_text_rect.top = 0 # new
    ...
    def prep_high_score(self):
        ...
        self.high_score_text_rect.top = self.score_rect.top - 40
    ...
    def prep_level(self):
        ...
        self.level_text_rect.right = self.score_rect.right
    ...
    def show_score(self):
        ...
        self.screen.blit(self.score_text_image, self.score_text_rect) # new
        self.screen.blit(self.high_score_image, self.high_score_rect)
        self.screen.blit(self.high_score_text_image, self.high_score_text_rect) # new
        self.screen.blit(self.level_image, self.level_rect)
        self.screen.blit(self.level_text_image, self.level_text_rect) # new
